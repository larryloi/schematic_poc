  ...
  FAIL_EXIT()
    {
      ...
      echo "== ${1} "
      echo "=="
      echo "== Usage: bash deploy/scripts/stored_procedure_create"
      echo "== For example: bash scripts/stored_procedure_create"
      echo "=="
      exit 1
    }
...
#. $RVM_PATH/scripts/rvm
     ...
     SET_DB_VARIABLES
     ruby deploy/scripts/stored_procedure_create.rb
